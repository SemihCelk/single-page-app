...
export default function GrowCollection() {
  ...
  return (
    <div className="bg-[#fefcf4] relative">
      <div className="p-20 z-20 relative">
        <h1 className=" text-slate-900 text-6xl font-extrabold">
        ...
        <div className={`flex`}>
          <div className="2xl:w-2/12 min-w-60 flex flex-col">
            {btnGroup.map((item, key) => (
              <button
                className="flex justify-between gap-3 p-3 hover:shadow-xl focus:shadow-xl hover:bg-white focus:bg-white rounded-md group font-semibold"
                key={key}
              >
