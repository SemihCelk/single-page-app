  ...
  return (
    <div className="w-full md:px-20 px-5 md:pt-48 pt-5 pb-32 flex-col justify-start items-start inline-flex md:bg-[#fefcf4] bg-white">
      <div className="w-full  bg-white shadow-xl rounded-3xl">
        <div className="md:flex justify-between pt-10 md:px-10 px-5">
          <div className="md:w-1/2 w-full lg:p-5">
            <h4 className="text-slate-900 md:text-6xl text-3xl md:text-start text-center font-bold font-roboto my-5">
              Why join us
            </h4>
          ...
          <div className="md:w-1/2  w-full  flex  items-center relative">
            ...
            <div className="md:w-56 w-40 md:h-56 h-44 lg:left-[75%] left-[60%] top-[58%] absolute opacity-75 bg-pink-700 rounded-3xl" />
