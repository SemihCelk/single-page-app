...
export default function Footer() {
  const navigation = {
    ...
    others: [{ name: "Terms" }, { name: "Privacy" }, { name: "Contract" }],
    social: [
      {
        name: "Youtube",
        href: "#",
  ...
  return (
    <footer className="bg-slate-900">
      <div className="md:px-20 px-5 md:text-start text-center pb-8 md:pt-16 pt-8">
        <div className="grid grid-cols-1 md:grid-cols-4 xl:gap-8 space-y-10">
          ...
          <div>
            <div>
              ...
              <Link
                href="#"
                className="md:block flex flex-col items-center my-5"
              >
                <Image
                  src="/app-store.svg"
                  height={100}
            ...
            <div className="text-[#E2E8F0] mt-12">Follow Us</div>

            <div className="flex md:justify-start justify-center gap-5 my-5">
        ...
        <div className="md:mt-8 border-t border-[#e2e8f03f] pt-8 md:flex md:items-center md:justify-between">
          <p className="text-xs leading-5 text-[#E2E8F0] md:mt-0">
            Collers @ 2023. All rights reserved.
          </p>
          <div className="flex md:justify-start justify-center gap-3 my-4">
            {navigation.others.map((item, key) => (
